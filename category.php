...
$page=$page-1;
$p= $page * $rowsperpage;
$query = "SELECT * FROM books limit ".$p.",".$rowsperpage ;
			...
			<div class="container">
				<div class="banner_content text-center text-light">
					...
					<div class="page_link">
						...
						<a href="category.php?p=1">Books</a>
					</div>
				</div>
			</div>
		</div>
		...
		<?php
                while($row=mysqli_fetch_array($result))
                {
                  ?>	 
						...
						<div class="f_p_item">
                            ...
                            <a href="product_single.php?id=<?php echo $row['Id']; ?>" class="btn btn-outline-success mt-3">Description</a>
                            </div>
				</div>			
			...
			<div class="row">
				<nav class="cat_page mx-auto" aria-label="Page navigation example">
					<ul class="pagination">
						<li class="page-item">
							<a class="page-link" href="category.php?p=1">01</a>
						</li>
						<li class="page-item">
							<a class="page-link" href="category.php?p=2">02</a>
						</li>
						<li class="page-item">
							<a class="page-link" href="category.php?p=3">03</a>
						</li>
						<li class="page-item">
							<a class="page-link" href="category.php?p=4">04</a>
						</li>
						<li class="page-item">
							<a class="page-link" href="category.php?p=5">05</a>
						</li>
						<li class="page-item">
							<a class="page-link" href="category.php?p=6">06</a>
						</li>
						<li class="page-item">
							<a class="page-link" href="category.php?p=7">07</a>
						</li>
					</ul>
				</nav>
			</div>
